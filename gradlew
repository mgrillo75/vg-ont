...
if [ -z "${JEMMA:-}" ]; then
    if [ "${FOUNDRY_CONTAINER_RUNTIME_TYPE:-}" = "CODE_WORKSPACE" ]; then
        ...
        export ORG_GRADLE_PROJECT_thirdPartyApplicationServiceApiUri=$(uri third_party_application_service)
        ...
        export ORG_GRADLE_PROJECT_thirdPartyApplicationServiceApiUri=$ORG_GRADLE_PROJECT_externalUri/third-party-application-service/api
